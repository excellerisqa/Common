...
public class Report_BillingBC_BAInvoiceWSBCPage extends LoadableComponent<Report_BillingBC_BAInvoiceWSBCPage> {
	...
	public Report_BillingBC_BAInvoiceWSBCPage(WebDriver driver) {
		this.driver = driver;
