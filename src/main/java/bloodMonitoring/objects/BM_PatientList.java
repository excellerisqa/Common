...
public class BM_PatientList {
	...
	@FindBy(xpath = "//div[@id='DueDateWindow']/div/div[2]/input[1]")
	public static WebElement resetTestDueDatesOkButton;
	@FindBy(xpath = "//div[@id='DueDateWindow']/div/div[2]/input[2]")
	public static WebElement resetTestDueDatesCancelButton;
	@FindBy(xpath = "//div[@id='DueDateWindow']/div/div[1]/div/span")
	public static WebElement resetTestDueDatesTitle;

	@FindBy(id = "acknowledgeAlertsBtn")
	public static WebElement ackKAlertButton;
	@FindBy(id = "acknowledgeBtn")
	public static WebElement ackKAlertSelectedButton;
	@FindBy(xpath = "//div[@id='acknowledgeAlertsDiv']/div/div/div[1]/h4")
	public static WebElement ackAlertResultsTitle;
	@FindBy(id = "acknowledgeAllCheckbox")
	public static WebElement ackKAllCheckbox;
	@FindBy(xpath = "//div[@id='acknowledgeAlertsDiv']/div/div/div[3]/button[2]")
	public static WebElement ackKAlertCloseButton;
	...
	@FindBy(xpath = "//div[@id='testResultsContent']/div[1]/div/div[1]/div[1]/ul/li")
	public static WebElement ResultstableErrorMsg;

	public final static Logger logger = Logger.getLogger("Delegation");

	public BM_PatientList(WebDriver driver) {
		this.driver = driver;
	...
	public void OpeningBloodMonitorApplication() throws Exception {
		...
		CommonFunctions.waitForVisiblity(By.id("patientListIndex_info"), 30);
	}
	...
	public void commonFunctionForEnteringResults(ITestContext con) throws Exception {
		String testDataFileName = con.getCurrentXmlTest().getParameter("testDataFile");
		String[] TestResults = XLHandler.readexcel("Sheet1", 13, testDataFileName);
		...
		CommonFunctions.waitForVisiblity(TestResultsTitle, 25);
		logger.info("TestResultsTitle.getText()" + TestResultsTitle.getText());
		logger.info("TestResult.get(1)" + TestResult.get(1));
