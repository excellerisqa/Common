...
public class Billing_ReportsForFinance_AgingReportMonthlyARDeckPage extends LoadableComponent<Billing_ReportsForFinance_AgingReportMonthlyARDeckPage> {
	...
	public Billing_ReportsForFinance_AgingReportMonthlyARDeckPage(WebDriver driver) {
		this.driver = driver;
