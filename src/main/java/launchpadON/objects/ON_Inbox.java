...
public class ON_Inbox {
	...
	// new element for search
	public static By totalSearchResults = By.xpath("//table[@id='HistSearchResults']//table//tr");
	public static By totalInboxCount = By.xpath("//table[@id='ResultTable']/tbody/tr");
	...
	public static void searchpatientbynamesex(String lastname, String firstname) throws InterruptedException {
		...
		System.out
				.println("div text:" + ObjectHelper.driver.findElement(By.xpath("//div[@id='Sex_item_2']")).getText());
		ObjectHelper.driver.findElement(By.xpath("//div[@id='Sex_item_2']")).click();
