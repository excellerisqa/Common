...
public class Report_BillingBC_BAInvoiceSinglePatientPage extends LoadableComponent<Report_BillingBC_BAInvoiceSinglePatientPage> {
	...
	public Report_BillingBC_BAInvoiceSinglePatientPage(WebDriver driver) {
		this.driver = driver;
