...
public class Report_BillingBC_BAInvoiceSingleInvoicePage extends LoadableComponent<Report_BillingBC_BAInvoiceSingleInvoicePage> {
	...
	public Report_BillingBC_BAInvoiceSingleInvoicePage(WebDriver driver) {
		this.driver = driver;
