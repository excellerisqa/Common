...
public class Report_BillingBC_BAInvoiceMultiplePatientPage extends LoadableComponent<Report_BillingBC_BAInvoiceMultiplePatientPage> {
	...
	public Report_BillingBC_BAInvoiceMultiplePatientPage(WebDriver driver) {
		this.driver = driver;
