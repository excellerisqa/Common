...
public class Report_BillingBC_InvoiceSelfPayPage extends LoadableComponent<Report_BillingBC_InvoiceSelfPayPage> {
	...
	public Report_BillingBC_InvoiceSelfPayPage(WebDriver driver) {
		this.driver = driver;
